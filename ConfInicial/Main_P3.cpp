...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Proyecciones y transformaciones basicas- José César Cortés Hernández", nullptr, nullptr);
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glDrawArrays(GL_TRIANGLES, 0, 36);
		//
		//dibujando el cubo extra
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-6.0f, 0.0f, 0.0f));
		model = glm::rotate(model, -60.0f, glm::vec3(0.0f, 0.0f, 1.0f)); // use to compare orthographic and perspective projection
