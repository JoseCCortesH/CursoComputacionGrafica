...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Jose Cesar Cortes Hernandez - Materiales e Iluminacion", nullptr, nullptr);
    ...
    Model arbol((char*)"Models/Lowpoly_tree_sample.obj");
    Model sol((char*)"Models/Sol.obj"); 
    Model skull((char*)"Models/skull.obj");
