...
int main()
{
	...
	//// =============================================
	//	glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.position"), 0.0f, 5.0f, 0.0f);  // Posición en el techo
	//	glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.direction"), 0.0f, -1.0f, 0.0f); // Dirección hacia abajo
	...
	//	glUniform1f(glGetUniformLocation(lightingShader.Program, "spotLight.cutOff"), glm::cos(glm::radians(10.0f)));  // Ángulo estrecho
